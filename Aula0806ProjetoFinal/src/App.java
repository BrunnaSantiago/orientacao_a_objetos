...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        quartos[0] = new QuartoSimples(101, 150.0);
        quartos[1] = new QuartoSimples(102, 150.0);
        quartos[2] = new QuartoSimples(103, 150.0);
        quartos[3] = new QuartoLuxo(201, 250.0);
        quartos[4] = new QuartoLuxo(202, 250.0);
